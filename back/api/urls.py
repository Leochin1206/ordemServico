...
urlpatterns = [
    ...
    path('gest/<int:pk>', GestoresDetailView.as_view()),
    ...
    path('manutent/<int:pk>', ManutentoresDetailView.as_view()),
    ...
    path('ordemServ/<int:pk>', OrdemServicoDetailView.as_view()),
    ...
    path('patri/<int:pk>', PatrimoniosDetailView.as_view()),
    ...
    path('responsa/<int:pk>', ResponsaveisDetailView.as_view()),
