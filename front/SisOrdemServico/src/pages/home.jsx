            ...
            <div className="flex flex-wrap items-center justify-center w-[70%] h-[700px] !mt-12 shadow-lg">
                {paginas.map((pag, index) => (
                    <div key={index} className="flex items-center justify-center w-[43%]">
                        <Link to={pag.link}>
                            <div className="flex items-center justify-center w-[280px] shadow-lg text-white bg-[#007bc0] border-3 border-[#007bc0] hover:bg-white hover:text-[#007bc0] transition-all duration-300 hover:scale-110">
