...
export function Manutentores() {
  ...
  return (
    <div className="bg-gray-50 flex flex-col items-center w-full py-12 px-4">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Manutentores</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-[1100px]">
        {dados.map((manutentor) => (
          <div key={manutentor.id} className="bg-white shadow-md rounded-xl p-4 flex justify-between items-center hover:shadow-lg transition-all">
            <div>
              <p className="text-sm text-gray-500">ID #{manutentor.id}</p>
